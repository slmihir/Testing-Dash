...
export function TestResultCard({ test }: TestResultCardProps) {
  ...
  return (
    <Card className={`${cardClasses} transition-all duration-300 animate-slide-up group bg-white dark:bg-vercel-gray-900`}>
        ...
        <div className={`border-t ${test.status === 'failed' ? 'border-red-100 dark:border-red-900/30 bg-red-50 dark:bg-red-900/10' : 'border-vercel-gray-100 dark:border-vercel-gray-800 bg-vercel-gray-50 dark:bg-vercel-gray-900/50'}`}>
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-vercel-gray-800 rounded-lg p-4">
                <h4 className="text-sm font-medium text-vercel-gray-900 dark:text-vercel-gray-100 mb-2">
              ...
              <div className="bg-white dark:bg-vercel-gray-800 rounded-lg p-4">
                <h4 className="text-sm font-medium text-vercel-gray-900 dark:text-vercel-gray-100 mb-2">Attachments</h4>
              ...
              <div className="bg-white dark:bg-vercel-gray-800 rounded-lg p-4">
                <h4 className="text-sm font-medium text-vercel-gray-900 dark:text-vercel-gray-100 mb-2">Performance</h4>
